...
public class Ypo2Server extends Thread {
    protected Socket clientSocket;
    // static to be shared between instances of Ypo2Server Threads
    private static Hashtable<Integer, Integer> table = new Hashtable<>((int) Math.pow(2, 20));

    private Ypo2Server(Socket clientSocket) {
    ...
    public static void main(String[] args) throws IOException {
        ...
        try {
            ...
            System.out.println("Connection Socket Crated");
            try {
                while (true) {
                    System.out.println("Waiting for Connection");
                    new Ypo2Server(serverSocket.accept());
                }
            } catch (IOException e) {
